...
func resolveFileDescriptor(unresolved map[string]*descpb.FileDescriptorProto, resolved map[string]*desc.FileDescriptor,
	filename string) (*desc.FileDescriptor, error) {
